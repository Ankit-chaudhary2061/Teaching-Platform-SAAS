...
router.post(
  '/teacher',
 MiddleWare.isLogedIn,upload.single('teacherPhoto'),TeacherController.createTecaher
);
router.delete('/course/:id',MiddleWare.isLogedIn,TeacherController.createTecaher )
